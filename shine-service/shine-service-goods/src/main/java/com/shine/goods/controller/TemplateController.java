...
import com.shine.goods.service.TemplateService;
...
public class TemplateController {
     ...
     * @return
     */
    @ApiOperation(value = "Template条件分页查询")
    //@ApiImplicitParams({
    //        @ApiImplicitParam(paramType = "path", name = "page", value = "当前页", required = true, dataType = "Integer"),
    //        @ApiImplicitParam(paramType = "path", name = "size", value = "每页显示条数", required = true, dataType = "Integer")
    //})
    @PostMapping(value = "/search/{page}/{size}" )
    public ServerResponse findPage(@RequestBody(required = false) @ApiParam(name = "Template对象",value = "传入JSON数据",required = false) Template template, @PathVariable  int page, @PathVariable  int size){
     ...
     * @return
     */
    @ApiOperation(value = "Template分页查询")
    //@ApiImplicitParams({
    //        @ApiImplicitParam(paramType = "path", name = "page", value = "当前页", required = true, dataType = "Integer"),
    //        @ApiImplicitParam(paramType = "path", name = "size", value = "每页显示条数", required = true, dataType = "Integer")
    //})
     ...
     * @return
     */
    @ApiOperation(value = "Template条件查询")
    @PostMapping(value = "/search" )
    public ServerResponse findList(@RequestBody(required = false) @ApiParam(name = "Template对象",value = "传入JSON数据",required = false) Template template){
     ...
     * @return
     */
    @ApiOperation(value = "Template根据ID删除")
     ...
     * @return
     */
    @ApiOperation(value = "Template根据ID修改")
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Integer")
    @PutMapping(value="/{id}")
    public ServerResponse update(@RequestBody @ApiParam(name = "Template对象",value = "传入JSON数据",required = false) Template template, @PathVariable Integer id){
        //设置主键值
        template.setId(id);
     ...
     * @return
     */
    @ApiOperation(value = "Template添加")
    @PostMapping
    public ServerResponse add(@RequestBody  @ApiParam(name = "Template对象",value = "传入JSON数据",required = true) Template template){
